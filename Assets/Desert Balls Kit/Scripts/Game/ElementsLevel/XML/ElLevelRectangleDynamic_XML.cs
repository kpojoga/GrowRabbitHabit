...
public class ElLevelRectangleDynamic_XML : BaseElLevel_XML
{
    public Vector2 Point1;
    public Vector2 Point2;


    public ElLevelRectangleDynamic_XML()
    {
    ...
    public override void SetValuesGameObject()
    {
        ...
        {
            ((ElLevelRectangleDynamic)_BaseElLevel).Point1 = Point1;
            ((ElLevelRectangleDynamic)_BaseElLevel).Point2 = Point2;
        }
    }
    ...
    public override void Default()
    {
        ...
        Point1 = new Vector2(1, 0.1f);
        Point2 = new Vector2(-1, -0.1f);
    }
}
