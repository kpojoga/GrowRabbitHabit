...
public class ElLevelRectangle_XML : BaseElLevel_XML
{
    public Vector2 Point1;
    public Vector2 Point2;


    public ElLevelRectangle_XML()
    {
    ...
    public override void SetValuesGameObject()
    {
        ...
        {
            ((ElLevelRectangle)_BaseElLevel).Point1 = Point1;
            ((ElLevelRectangle)_BaseElLevel).Point2 = Point2;
        }
    }
